const CACHE='grounded-v8';
const ASSETS=['./','./index.html','./styles.css','./auth.css','./routines.css','./routine-builder.css','./supabase-2.106.2.js','./app.js','./manifest.webmanifest','./icon.svg'];
