const CACHE='grounded-v10';
const ASSETS=['./','./index.html','./styles.css','./auth.css','./routines.css','./routine-builder.css','./food.css','./supabase-2.106.2.js','./app.js','./manifest.webmanifest','./icon.svg'];
